<div id="contenidoCrud">
    ...
    <div>
         	<ul>
         		  ...
         		  <li class="centrarli"><a id="cobrar11" href="#!" class="amber accent-3 btn white-text tamaniobot " ><i class="material-icons left"><img class="iconotab" src="../app/img/generarv.png" /></i>Cuentas Por Cobrar</a></li>
         	</ul>
          </div>
